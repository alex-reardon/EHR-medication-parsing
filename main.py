...
df = pd.read_csv("data/eicu/raw/eicu_medication.csv")
...
df = apply_rxnorm_mapping(df, input_col= "paren_text", rrf_path="/Users/emudr/Desktop/data/RXNCONSO.RRF", out1 = "rxmatch0", out2 = "rxcui0", out3 = "score0", out4 = 'tty0', col_str_name = col_str_name)
...
#save_unmapped(df, input_col = col_str_name + "normalized_no_form", mapped_col = 'freq_raw', output_path = outdir + 'freq_unmapped.csv')
...
df = apply_category_extraction(df, input_col = col_str_name + "no_route", output_col = col_str_name + "no_time", category = "time_of_day" , data_path = norm_path)
df = apply_rxnorm_mapping(df, input_col= col_str_name + "no_time", rrf_path="/Users/emudr/Desktop/data/RXNCONSO.RRF", out1 = "rxmatch1", out2 = "rxcui1", out3 = "score1", out4 = 'tty1')
