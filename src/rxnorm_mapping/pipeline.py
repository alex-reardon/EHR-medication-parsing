...
def rxnorm_map(
    ...
    df = apply_rxnorm_mapping(df, input_col = "parenthetical_text", rxnorm_rrf_path = rxnorm_rrf_path, rxnrel_rrf_path = rxnrel_rrf_path, suffix = "_parenthetical_text")
    df = apply_rxnorm_mapping(df, input_col = "clean_text", rxnorm_rrf_path = rxnorm_rrf_path, rxnrel_rrf_path = rxnrel_rrf_path, suffix = "_clean_text")
